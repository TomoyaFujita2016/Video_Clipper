...
lib_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "../libdarknet.so"))
...
def get_net(cfg, wgt):
    return load_net(cfg.encode("ascii"), wgt.encode("ascii"), 0)

def get_meta(cl):
    return load_meta(cl.encode("ascii"))
